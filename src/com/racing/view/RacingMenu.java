	...
	public void favoriteHrList() {
		...
		while (true) {
			...
			case 3:
				...
				break;
//			case 4:
//				System.out.print("즐겨찾기 번호를 입력하세요 : ");
//				String fvHNO = Util.readStrForConsol();
//				fhList = favorite_HorseController.selectByFavoriteNum(fvHNO);
//				if (fhList.size() < 1) {
//					System.out.println("찜이 존재하지 않습니다.");
//				} else {
//					for (Favorite_Horse item : fhList) {
...
//				System.out.print("즐겨찾기 번호를 입력하세요 : ");
//				String fvHNO = Util.readStrForConsol();
//				fjList = favorite_JockeyController.selectByFavoriteNum(fvHNO);
//				if (fjList.size() < 1) {
//					System.out.println("찜이 존재하지 않습니다.");
//				} else {
//					for (Favorite_Jockey item : fjList) {
...
//				returnButton();
	...
	private void catRFmenu() {
		...
		while (true) {
			...
			switch (catNum) {
//				case 1:  // 마권사는곳 - 부산경남만 존재
//					catList = raceFacilityController.selectByBuyTicket();
