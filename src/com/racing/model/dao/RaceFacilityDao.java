...
//	// 전체검색
//	public List<RaceFacility> selectAll(Connection conn) {
//		List<RaceFacility> list = new ArrayList<>();
//		PreparedStatement pstmt = null;
//		ResultSet rs = null;
//
//		try {
//			String sql = "SELECT * FROM racefacility ORDER BY fltseq";
...
//				
//
//				RaceFacility info = new RaceFacility(fltSeq, fltTitle, fltEcodeName, fltEndday, fltHour, fltLcodeName, fltMcodeName, fltObjText, fltPositionAdd, fltRentStatusName, fltScodeName, fltStatusName, fltText);
//				list.add(info);
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
	...
	public int insert(Connection conn, RaceFacility raceFacility) {
		try {
			String sql = "INSERT INTO "
					+ "RACEFACILITY(fltSeq, fltTitle, fltEcodeName, fltEndday, fltHour, "
