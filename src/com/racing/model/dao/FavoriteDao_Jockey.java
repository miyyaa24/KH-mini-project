...
//				int JNO = rs.getInt("JNO");
	...
	public List<Favorite_Jockey> selectByName(Connection conn,int uNo, String jockeyName) {
		...
		try {
			String sql = "SELECT DISTINCT u.uno, j.jkname, j.jkno "
					+ "FROM FAVORITE_JOCKEY FJ, USERINFO U, JOCKEY J "
			...
			while (rs.next() == true) {
				...
				String jkno = rs.getString("jkno");
				Favorite_Jockey fvj = new Favorite_Jockey(uno, jkname, jkno);
				list.add(fvj);
			}
			return list;
		} catch (Exception e) {
...
//	public List<Favorite_Jockey> selectByFavoriteNum(Connection conn, String fvHNO) {
		// 즐겨찾기 테이블에서 즐겨찾기 번호를 입력받아서 해당하는 즐겨찾기 된 기수명/기수번호/생년월일 출력
//		List<Favorite_Jockey> list = new ArrayList<>();
//		PreparedStatement pstmt = null;
//		ResultSet rs = null;
//		try {
//			String sql = "SELECT j.jkname, j.jkno "
//					+ "FROM FAVORITE_JOCKEY FJ, USERINFO U, JOCKEY J "
//					+ "WHERE FJ.jkNo = J.jkNo AND FJ.UNO = u.uno AND fj.jno = ? "; 
...
//				String jkname = rs.getString("jkname");
//				String jkno = rs.getString("jkno");
//				Favorite_Jockey fvj = new Favorite_Jockey(jkname, jkno);
//				list.add(fvj);
//			}
//			return list;
//		} catch (Exception e) {
...
//		int dresult = new FavoriteDao_Jockey().delete(conn, 0, "002");
//		System.out.println(dresult);

//		int iresult = new FavoriteDao_Jockey().insert(conn, 0, "002");
//		System.out.println(iresult);

//		List<Favorite_Jockey> list = new FavoriteDao_Jockey().selectAll(conn);
//		for (Favorite_Jockey info : list) {
//			System.out.println(info.toString());
//		}
//		System.out.println();

//		list = new FavoriteDao_Jockey().selectByName(conn, "");
//		for (Favorite_Jockey info : list) {
//			System.out.println(info.toString());
//		}
//		System.out.println();

//		list = new FavoriteDao_Jockey().selectByJockeyNumber(conn, "002");
//		for (Favorite_Jockey info : list) {
//			System.out.println(info.toString());
//		}
//		System.out.println();

//		list = new FavoriteDao_Jockey().selectByFavoriteNum(conn, "002");
//		for (Favorite_Jockey info : list) {
//			System.out.println(info.toString());
//		}
//		System.out.println();
