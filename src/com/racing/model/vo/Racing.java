...
public class Racing {
	...
	public Racing(int rNO, String rcDate, int rcNo, int rcDist, int rcOrd, double rcTime, int rcChul,
			String hrno, String hrName, int wgHr, String jkNo, String jkName, int chaksun, String weath) {
		super();
		RNO = rNO;
		this.rcDate = rcDate;
		this.rcNo = rcNo;
...
//		return "rc_Info [RNO=" + RNO + ", rcDate=" + rcDate + ", rcNo=" + rcNo + ", rcDist=" + rcDist + ", rcOrd="
//				+ rcOrd + ", rcTime=" + rcTime + ", rcChul=" + rcChul + ", hrno=" + hrno + ", hrName=" + hrName
//				+ ", wgHr=" + wgHr + ", jkNo=" + jkNo + ", jkName=" + jkName + ", chaksun=" + chaksun + ", weath="
//				+ weath + "]";
//	}
