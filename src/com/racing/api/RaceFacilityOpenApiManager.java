...
//			conn.setRequestProperty("Content-type", "application/json");
			...
			for(int i = 0; i <itemList.getLength(); i++) {
				...
				RaceFacility raceFacility = new RaceFacility(fltSeq, fltTitle, fltEcodeName, fltEndday, fltHour, fltLcodeName, fltMcodeName, fltObjText, fltPositionAdd, fltRentStatusName, fltScodeName, fltStatusName, fltText);
				rList.add(raceFacility);
//				System.out.println(raceFacility.toStringForConsole());
