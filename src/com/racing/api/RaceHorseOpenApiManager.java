...
//					Date birthday = sdf.parse(eElement.getElementsByTagName("birthday").item(0).getTextContent());
					...
					list.add(horse);
//					System.out.println(horse.toStringForConsole());
//					System.out.println("===========================");

				}
//				System.out.println("페이지 끝 다음페이지 시작");
//				page++;
//				if (page > 25161) {
//					break;
//				}
